...
namespace Pushe.android
{
    static class PusheAndroidUtils
    {
        ...
        public static AndroidJavaObject PusheFcmService()
        {
            return PusheAndroidUtils.Native().CallStatic<AndroidJavaObject>("getPusheService", "fcm");
        }
        public static AndroidJavaObject PusheHmsService()
        {
            return PusheAndroidUtils.Native().CallStatic<AndroidJavaObject>("getPusheService", "hms");
        }
