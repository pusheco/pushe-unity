...
namespace Pushe.android
{
    ...
    public static class PusheNotification
    {
        ...
        public static void SendNotificationToUser(UserNotification userNotification)
        {
            ...
            switch (userNotification.Type)
            {
                case UserNotification.IdType.CustomId:
                    ...
                    break;
                case UserNotification.IdType.DeviceId:
                    userNotif = userNotifClass.CallStatic<AndroidJavaObject>("withDeviceId", userNotification.Id);
                    break;
        ...
        public static void EnableNotificationForceForegroundAware()
        {
            PusheAndroidUtils.PusheNotificationService().Call("enableNotificationForceForegroundAware");
        }
    ...
    public class UserNotification
    {
        ...
        public static UserNotification WithDeviceId(string deviceId)
        {
            return new UserNotification(IdType.DeviceId, deviceId);
        }
